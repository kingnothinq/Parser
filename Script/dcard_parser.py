...
def parse_R5000(dcard_raw_text_string, dcard_raw_text_list):
    ...
    interfaces_settings = {'eth0': None, 'eth1': None,
                           settings = {'Role': None, 'Interface Status': {
        'eth0': None,
        'eth1': None,
        'rf5.0': None}, 'QM': None, 'MINT': mint
...
def parse_XG(dcard_raw_text_string, dcard_raw_text_list):
    ...
    pattern = re.search(r"# xg -atpc-master-enable (\d+)",
                        dcard_raw_text_string).group(1)
    ...
    pattern = re.search(r"# xg -idfs-enable (\d+)",
                        dcard_raw_text_string).group(1)
